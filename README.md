# Cinema App (Java Android)

Projeto Java Android do livro "Receitas Para Desenvolvedores Android".

Projeto apresentado no **Capítulo 5** do livro, mais precisamente o capítulo "Monetização Eficiente Com Mais de Uma API de Anúncios".

<img src="https://www.thiengo.com.br/img/livro/receitas-para-desenvolvedores-android/github/aplicativo-android-capitulo-05.jpg" alt="Tela do aplicativo Android do capítulo 5" height="360">

**Observação importante:** para o total entendimento do projeto é preciso ter em mãos o livro "Receitas Para Desenvolvedores Android" com o capítulo 5 já aberto, pois as explicações detalhadas de todo o projeto deste repositório estarão nesta parte do livro.
